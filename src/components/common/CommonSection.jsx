    ...
    return (
        <div className={`max-xl:py-3 max-lg:py-5 flex justify-center items-center min-h-screen ${sectionClass}`}>
            <div className='max-w-[1140px] w-full mx-auto container'>
                <div className='flex justify-center min-h-[735px] max-xl:min-h-[674px] gap-4 items-center !h-full w-full max-lg:flex-col'>
                    <div className={`py-4 px-[26px] max-md:px-4 max-sm:px-4 min-h-[735px] max-xl:min-h-[674px] max-w-[519px] max-lg:max-w-[unset] max-lg:min-h-[unset] w-full gap-[26px] max-xl:gap-4 flex flex-col bg-green rounded-2xl ${dataClass}`}>
