...
const CommonSection = ({ description, sectionImage, bgImage, descriptionClass, titleClass, descriptionTwo, descriptionThree, descriptionFour, titleOne, titleTwo, secondDescription, secondDescriptionTwo, secondDescriptionThree, secondDescriptionFour, dataClass, sectionClass }) => {
    return (
        <div className={`max-xl:py-10 max-lg:py-5 flex justify-center items-center min-h-screen ${sectionClass}`}>
            <div className='max-w-[1140px] w-full mx-auto container'>
                <div className='flex justify-center min-h-[735px] gap-4 items-center !h-full w-full max-lg:flex-col'>
                    <div className={`py-4 px-[26px] max-md:px-4 max-sm:px-4 min-h-[735px] max-w-[519px] max-lg:max-w-[unset] max-lg:min-h-[unset] w-full gap-[26px] max-lg:gap-4 flex flex-col bg-green rounded-2xl ${dataClass}`}>
                    ...
                    <div className={` min-h-[735px] max-lg:min-h-[unset] max-lg:py-3 rounded-2xl max-xl:px-4 bg-cover max-w-[603px] w-full h-full flex justify-center items-center ${bgImage}`}>
